...
const float HLFPNY=0.005f;//The value of a half penny
const float CNVPNYS=100.0f;//Conversion to Pennies
...
int main(int argc, char** argv) {
    ...
    totGal=nGals+galDrv;
    cost=totGal*ppg;
    int icstPny=(cost+HLFPNY)*CNVPNYS;//Cost in Pennies round up
    cost=icstPny/CNVPNYS;//Convert back to dollars
