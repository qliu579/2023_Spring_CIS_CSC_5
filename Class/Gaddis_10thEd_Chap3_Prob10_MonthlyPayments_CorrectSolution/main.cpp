...
const float HLFPNY=0.005;//Half a penny
...
int main(int argc, char** argv) {
    ...
    int pennies=(mnPymt+HLFPNY)*100;
    mnPymt=pennies/100.0f;
    ...
    cout<<"Monthly Interest Rate:      "<<setw(10)<<intRate*PERCENT<<"%"<<endl;
    cout<<"Number of Payments:         "<<setw(10)<<static_cast<int>(numPmts)<<endl;
